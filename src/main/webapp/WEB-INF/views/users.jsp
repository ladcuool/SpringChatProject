...
<body>
	...
	<div class="container d-flex flex-column" style="border:1px solid #4B89Dc; margin-top:70px; padding-bottom:50px; margin-bottom:30px;">
		<form class="row g-3" method="post" action="./update" enctype="multipart/form-data">
			<h1 class="text-primary" style="text-align:center; margin:30px;">Chat Company</h1>
			<div class="row">
				<div class="container col-md-1">
				</div>
				

				<div class="container col-md-4" style="margin-top:5%">
					<img src="${conpath}" class="img-thumbnail" id="img" name="img"/>
					<input class="form-control" type="file" id="userProfile" name="userProfile" accept="image/*">
				</div>
			...
			<div class="container col-md-10" style="margin-top:30px;">
				<div class="row justify-content-center">
					<div class="col-md-6">
						...
						<input type="password" class="form-control" onkeyup="passwordCheckfunction();" id="userPassword" name="userPassword" placeholder="비밀번호를 입력해주세요.">
						<p style="color:red;" id="passwordCheckMessage" name="passwordCheckMessage"></p>
					</div>
					<div class="col-md-6">
						<label for="userPassword2" class="form-label">비밀번호 확인</label>
						<input type="password" class="form-control" onkeyup="passwordCheckfunction();" id="userPassword2" name="userPassword2" placeholder="비밀번호를 다시 입력해주세요.">
					</div>				
				</div>
				<div class="row justify-content-center">
					<div class="col-12">
				...
				<div class="row justify-content-end">
					<a class="col-md-2 btn btn-primary" href="userwithdrawal" style="margin-top:50px; margin-right:10px;">회원탈퇴</a>
					<input class="col-md-1 btn btn-primary" type="submit" value="수정"  style="margin-top:50px;">	
				</div>			
			</div>
		</form>
	</div>
