				...
				<!-- 처음 -->
					<nav class="d-flex justify-content-center align-items-center" aria-label="...">
  						<ul class="pagination">
  							...
  							<c:otherwise>
  								<li class="page-item">
						    		<a class="page-link" href="list?page=1" tabindex="-1" aria-disabled="true">처음으로</a>
    							</li>
  							</c:otherwise>
  							</c:choose>
  							<!-- 이전 -->
  							...
  							<c:otherwise>
  								<li class="page-item">
						    		<a class="page-link" href="list?page=${page.curPage-1}" tabindex="-1" aria-disabled="true">이전</a>
    							</li>
  							</c:otherwise>
  							</c:choose>
  							...
  							<c:forEach var="fEach" begin="${page.startPage}" end="${page.endPage}" step="1">
  								...
  								<c:otherwise>
  									<li class="page-item">
					    				<a class="page-link" href="list?page=${fEach}">${fEach}</a>
						   			 </li>
  								</c:otherwise>
  								</c:choose>
  							</c:forEach>
					    	...
					    	<c:otherwise>
					    		<li class="page-item">
      								<a class="page-link" href="list?page=${page.curPage+1}">다음</a>
					    		</li>	
					    	</c:otherwise>
					    	</c:choose>
					    	<!-- 끝 -->
					    	...
					    	<c:otherwise>
					    		<li class="page-item">
      								<a class="page-link" href="list?page=${page.totalPage}">끝으로</a>
					    		</li>	
					    	</c:otherwise>
					    	</c:choose>
  						</ul>
